...
const socials = [
  { label: "GitHub", href: "https://github.com/Zachary-Roland", icon: "github" },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/zachary-roland-04544b79/", icon: "linkedin" },
  { label: "Instagram", href: "https://www.instagram.com/indigomaha", icon: "instagram" },
  { label: "Bluesky", href: "https://bsky.app/profile/indigomaha.bsky.social", icon: "bluesky" },
] as const;
